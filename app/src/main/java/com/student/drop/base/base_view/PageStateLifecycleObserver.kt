...
import com.student.drop.bean.ProgressInfo
...
class PageStateLifecycleObserver(
    ...
    private val mLoadingProgressDULy = lazy {
        val dialogUtil = com.student.drop.util.DialogUtil
        ...
        LiveEventBus
            .get("VCashApp-CircleProgressBar", ProgressInfo::class.java)
    ...
    fun setPageListener(mVM: BViewModel) {
        mVM.mBRepo.mPageStateMLD.observe(
            mContext as LifecycleOwner,
            { vCashPageState -> // 圆形进度条
